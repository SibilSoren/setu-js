---
title: Database
description: Database setup with Prisma, Drizzle, or Mongoose.
---

The `database` component sets up your database with your choice of ORM: **Prisma** or **Drizzle** for PostgreSQL, or **Mongoose** for MongoDB.
